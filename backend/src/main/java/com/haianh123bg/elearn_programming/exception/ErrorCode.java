...
public enum ErrorCode {
    ...
    PRODUCT_NOT_EXITS(1020, "Sản phẩm không tồn tại", HttpStatus.BAD_REQUEST),
    ...
    COURSE_NOT_EXIST(1027, "Khóa học không tồn tại", HttpStatus.BAD_REQUEST),
    ...
    CART_EMPTY(1031, "Không có khóa học trong giỏ hàng", HttpStatus.BAD_REQUEST),
    COURSE_NOT_FOUND(1032, "Không tìm thấy khóa học", HttpStatus.NOT_FOUND),
    COURSE_NOT_IN_CART(1033, "Không có khóa học nào trong giỏ hàng của bạn", HttpStatus.NOT_FOUND),
    ERROR_DELETE_CART(1034, "Xóa khóa học khỏi giỏ hàng thất bại", HttpStatus.BAD_REQUEST),
