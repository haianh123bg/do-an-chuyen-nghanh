...
import { IconStar, IconAlertCircle, IconTrash, IconChevronDown } from '@tabler/icons-react';
...
const EmailContent = () => {
    ...
    const emailDetailsList: EmailType[] = [emailDetails, emailDetails, emailDetails];
