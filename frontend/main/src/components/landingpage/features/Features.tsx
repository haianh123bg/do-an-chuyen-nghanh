...
const featuresData: FeaturesType[] = [
  {
    ...
    title: 'Thiết kế và phát triển cơ sở dữ liệu',
  },
  {
    icon: <IconWebhook width={40} height={40} strokeWidth={1.5} />,
    title: 'Phát triển web',
  },
  {
    icon: <IconWand width={40} height={40} strokeWidth={1.5} />,
    title: 'Phát triển ứng dung di động',
  },
  {
  ...
  },
  {
    ...
    title: 'Chứng chỉ Công nghệ thông tin',
  },
  {
