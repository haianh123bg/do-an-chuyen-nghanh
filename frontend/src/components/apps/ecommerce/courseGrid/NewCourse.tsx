...
const NewCourseSlider: React.FC = () => {
            ...
            details: (
                <Box sx={{ p: 2 }}>
                    ...
                    <Typography mt={1} mb={1}>
                        Develop Real-Time Spring Boot Unit Tests: JUnit 5, Mockito, MockMvc, TDD,
                        JsonPath, Hamcrest, H2 Embedded DB, MySQL
                    </Typography>
                    <Box>
                        <ul>
                            <li>
                                Explore the architecture of the Spring Boot testing framework and
        ...
        },
        {
            ...
            details: (
                <Box sx={{ p: 2 }}>
                    ...
                    <ul>
                        <li>
                            Explore the architecture of the Spring Boot testing framework and write
                            integration tests
                        </li>
                        <li>Develop unit tests with JUnit 5 and supporting JUnit Assertions</li>
                        <li>Mock Spring container dependencies using Mockito</li>
    ...
    return (
        <Box pb="0px" overflow="hidden" sx={{ pt: { sm: '60px', lg: '0' } }}>
            <Container maxWidth="lg">
                <Box>
                    <Typography variant="h5" mb={3}>
                        Mới và đáng chú ý trong ngôn ngữ lập trình
                    </Typography>
                    <Slider {...settings}>
                        {Courses.map((Course) => (
                            <Tooltip
