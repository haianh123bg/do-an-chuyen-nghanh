...
import { CodingExercise } from '../types/course';
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3, mt: 2 }}>
          ...
          <Box>
            ...
            <Typography variant="body2" color="text.secondary">
              • Test file should contain comprehensive test cases<br />
              • Include edge cases and error scenarios<br />
              • Provide clear error messages for failed tests<br />
              • Test both functionality and performance where applicable
            </Typography>
          </Box>
        </Box>
      </DialogContent>
